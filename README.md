...
Recognizes handwritten digits (0-9) using the scikit-learn digits dataset.
- **Model:** Support Vector Classifier (SVC)
- **Accuracy:** about 98.9%
- **File:** `Digit_recognition_using_supervised_learning.ipynb`

## Tools Used
Python, Pandas, NumPy, Matplotlib, Seaborn, scikit-learn, Google Colab

## How to Run
1. Click **Open in Colab** at the top of a notebook.
2. For the anemia project, upload `anemia.csv` to the Colab files panel.
3. Run all cells.
